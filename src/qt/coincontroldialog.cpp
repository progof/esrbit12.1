...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    int nDisplayUnit = ElsperoUnits::ESR;
    ...
    QString toolTip3 = tr("This label turns red if any recipient receives an amount smaller than %1.").arg(ElsperoUnits::formatHtmlWithUnit(nDisplayUnit, ::minRelayTxFee.GetFee(546)));
