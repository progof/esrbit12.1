...
unlocked to sign the Elspero-Qt.app bundle.
...
allowing somebody to distribute a Elspero-Qt.app or elspero-qt-setup.exe with a valid
...
that the elspero-qt.exe file inside the installer had not been tampered with.
