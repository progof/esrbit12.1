Elspero version 0.5.4 is now available for download at:
http://sourceforge.net/projects/elspero/files/Elspero/elspero-0.5.4/
...
http://gitorious.org/elspero/elsperod-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Elspero-Qt notifications under Growl 1.3.
Increase required age of Elspero-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxElspero properly when installing Elspero-Qt over it. (Windows)
