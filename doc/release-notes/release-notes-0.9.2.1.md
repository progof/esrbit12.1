Elspero Core version 0.9.2.1 is now available from:

  https://elspero.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ESR to 0.01 ESR
...
- Fix "Start elspero on system login"
