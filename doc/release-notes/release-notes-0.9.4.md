Elspero Core version 0.9.4 is now available from:

  https://elspero.org/bin/0.9.4/
...
this update is incompatible with the Elspero system and could lead to consensus
forks.

Elspero Core released binaries from https://elspero.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~elspero/+archive/ubuntu/elspero
- A third-party or self-compiled Elspero Core

upgrade to Elspero Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
