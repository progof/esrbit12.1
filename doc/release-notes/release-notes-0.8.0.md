Elspero-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/elspero/files/Elspero/elspero-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Elspero
...
New/changed settings (command-line or elspero.conf file)
--------------------------------------------------------
