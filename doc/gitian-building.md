...
*Setup instructions for a Gitian build of Elspero using a Debian VM or physical system.*
...
- [Building Elspero](#building-elspero)
...
git clone https://github.com/elspero/elspero
```
...
in the elspero repository under 'Fetch and build inputs' to install sources which require
...
To build Elspero (for Linux, OS X and Windows) just follow the steps under 'perform
...
Output from `gbuild` will look something like
    ...
    From https://github.com/elspero/elspero
...
For example:
```bash
URL=https://github.com/laanwj/elspero.git
...
ESRPATH=/some/root/path/elspero.git
SIGPATH=/some/root/path/elspero-detached-sigs.git

./bin/gbuild --url elspero=${ESRPATH},signature=${SIGPATH} ../elspero/contrib/gitian-descriptors/gitian-win-signer.yml
```
...
[elspero/gitian.sigs](https://github.com/elspero/gitian.sigs/) repository, or if that's not possible create a pull
