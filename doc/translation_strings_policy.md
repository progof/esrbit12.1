...
This document provides guidelines for internationalization of the Elspero Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `elspero_en.ts` remains unchanged.
